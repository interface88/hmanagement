...
<jsp:include page="../../theme/parts/header.jsp" />
	<table align="center" style="width: 70%; padding: 0;" class="simplebox">
		<tr>
			<td align="center" colspan="100%">
				<strong>Staff Master</strong>
			</td>
		</tr>
		<tr>
			<td colspan="100%" align="center">
				<font color="#00aa00"> <c:out value="${msg}" /> </font>
			</td>
		</tr>
		<tr>
			<td align="center">
				<table class="simpleboxtop">
					<tr>
						<td align="center">
							<form name="staffsMasterShow" method="post" action="staff">Staffs:&nbsp;&nbsp;
		...
		<tr>
			<td align="center">
				<form name="staffsMaster" method="post" action="staff">
					<input type="hidden" name="id" value="${staff.id}">
					<table>
						<tr>
							<td align="left">Name</td>
							<td>
								<input name="name" id="name" required="required" <c:if test="${editMode=='true'}"> readonly="readonly" </c:if> value="${staff.name}" type="text" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input name="dutyHours" id="fee" value="${staff.dutyHours}" type="text" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input name="userId" id="userId" value="${staff.userId}" type="text" /></td>
						</tr>
						<tr>
							<td align="left">Password</td> 
							<td><input name="password" id="password" value="${staff.password}" type="password" /></td>
						</tr>
						<tr>
							<td colspan="100%"></td>
						</tr>
