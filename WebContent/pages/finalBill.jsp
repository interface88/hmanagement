...
<jsp:include page="../theme/parts/header.jsp" />
	...
	<input type="text" name="doctorId" value="${ipd.doctor.id}" />
	<input type="text" name="admissionTypeId" value="${ipd.admissionType.id}" />
		<table style="width: 90%" class="tdright" cellpadding="3px">
			...
			<tr>
				...
				<td><input name="staffName" type="text" value="${finalBill.staffName}"/></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>Entry Date</td>
				<td><input name="entryDate" type="text" required="required" /></td>
			</tr>
			<tr>
				<td>Name</td>
				<td>Adm. Type</td>
			...
			<tr>
				...
				<td><input name="dischargeDate" type="text" style="width: 99px" /></td>
			...
			<tr>
				...
				<td><input type="text" name="billNo" required="required"/> </td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td class="auto-style1">Bill Date</td>
				<td><input type="text" name="billDate" required="required"/></td>
			</tr>
			<tr>
				<td colspan="6">
			...
			<tr>
				...
				<td><input style="text-align: right;" name="balanceReceiveAmount" type="text" onblur="balanceAmount(this.value);"/></td>
				...
				<td>Discount&nbsp; =</td>
				<td><input style="text-align: right;" id="discount" name="discount" type="text" onblur="applyDiscountAndTax(this.value,'discount');"/></td>
			</tr> 
			<tr>
				...
				<td>&nbsp;</td>
				<td>Tax&nbsp;&nbsp; =</td>
				<td><input style="text-align: right;" type="text" id="tax" name="tax" onblur="applyDiscountAndTax(this.value,'tax');"/> </td>
			</tr>
			<tr>
